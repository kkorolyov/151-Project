 ...
 */
public class HourMinuteTime extends AbstractTime implements Serializable {
	 ...
	 */
	public HourMinuteTime(int hour, int minute) throws TimeOutOfBoundsException {
		setTime(hour, minute);
	}
	/**
	 ...
	 * @throws TimeOutOfBoundsException when specified hour or minute out of bounds
	 */
	public HourMinuteTime(int hour, int minute, boolean pm) throws TimeOutOfBoundsException {
	...
	@Override
	public int compareTo(AbstractTime otherTime) {	// TODO Implement type restrictions
		int thisMinutes = (hour * 60) + minute, thatMinutes = (((HourMinuteTime) otherTime).hour * 60) + ((HourMinuteTime) otherTime).minute;	// Easier to compare
