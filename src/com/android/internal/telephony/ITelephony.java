...
public interface ITelephony extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_supplyPukForSubscriber: {
				...
				boolean _result = this.supplyPukForSubscriber(_arg0, _arg1,
						_arg2);
				reply.writeNoException();
				reply.writeInt(((_result) ? (1) : (0)));
				return true;
			...
			case TRANSACTION_supplyPinReportResultForSubscriber: {
				...
				java.lang.String _arg1;
				_arg1 = data.readString();
				int[] _result = this.supplyPinReportResultForSubscriber(_arg0,
						_arg1);
				reply.writeNoException();
				reply.writeIntArray(_result);
				return true;
			...
			case TRANSACTION_supplyPukReportResultForSubscriber: {
				...
				java.lang.String _arg2;
				_arg2 = data.readString();
				int[] _result = this.supplyPukReportResultForSubscriber(_arg0,
						_arg1, _arg2);
				reply.writeNoException();
				reply.writeIntArray(_result);
				return true;
			...
			case TRANSACTION_getCdmaEriTextForSubscriber: {
				...
				java.lang.String _result = this
						.getCdmaEriTextForSubscriber(_arg0);
				reply.writeNoException();
				reply.writeString(_result);
				return true;
			}
			...
			case TRANSACTION_getAllCellInfo: {
				data.enforceInterface(DESCRIPTOR);
				java.util.List<android.telephony.CellInfo> _result = this
						.getAllCellInfo();
				reply.writeNoException();
				reply.writeTypedList(_result);
				return true;
			...
			case TRANSACTION_iccOpenLogicalChannel: {
				...
				java.lang.String _arg0;
				_arg0 = data.readString();
				android.telephony.IccOpenLogicalChannelResponse _result = this
						.iccOpenLogicalChannel(_arg0);
				reply.writeNoException();
				if ((_result != null)) {
					reply.writeInt(1);
					_result.writeToParcel(reply,
			...
			case TRANSACTION_iccTransmitApduLogicalChannel: {
				...
				java.lang.String _result = this.iccTransmitApduLogicalChannel(
			...
			case TRANSACTION_iccTransmitApduBasicChannel: {
				...
				java.lang.String _result = this.iccTransmitApduBasicChannel(
			...
			case TRANSACTION_iccExchangeSimIO: {
				...
				java.lang.String _arg5;
				_arg5 = data.readString();
				byte[] _result = this.iccExchangeSimIO(_arg0, _arg1, _arg2,
						_arg3, _arg4, _arg5);
				reply.writeNoException();
			...
			case TRANSACTION_getCarrierPackageNamesForIntent: {
				...
				if ((0 != data.readInt())) {
					_arg0 = android.content.Intent.CREATOR
							.createFromParcel(data);
				} else {
					_arg0 = null;
				}
				java.util.List<java.lang.String> _result = this
						.getCarrierPackageNamesForIntent(_arg0);
				reply.writeNoException();
			...
			case TRANSACTION_setLine1NumberForDisplayForSubscriber: {
				...
				java.lang.String _arg2;
				_arg2 = data.readString();
				boolean _result = this.setLine1NumberForDisplayForSubscriber(
						_arg0, _arg1, _arg2);
				reply.writeNoException();
				reply.writeInt(((_result) ? (1) : (0)));
				return true;
			...
			case TRANSACTION_getLine1AlphaTagForDisplay: {
				...
				_arg0 = data.readInt();
				java.lang.String _result = this
						.getLine1AlphaTagForDisplay(_arg0);
				reply.writeNoException();
				reply.writeString(_result);
				return true;
			}
			...
			case TRANSACTION_setRoamingOverride: {
				...
				boolean _result = this.setRoamingOverride(_arg0, _arg1, _arg2,
						_arg3);
				reply.writeNoException();
				reply.writeInt(((_result) ? (1) : (0)));
				return true;
			...
			case TRANSACTION_setRadioCapability: {
				...
				_arg0 = data
						.createTypedArray(android.telephony.RadioAccessFamily.CREATOR);
		...
		private static class Proxy implements
			 ...
			 */
			@Override
			public void call(java.lang.String callingPackage,
					java.lang.String number) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
			...
			public boolean endCallForSubscriber(int subId)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_endCallForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public void answerRingingCallForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_answerRingingCallForSubscriber,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public boolean isOffhookForSubscriber(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_isOffhookForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Check if an incoming phone call is ringing or call waiting on a
			 * particular subId.
			 *
			 * @param subId
			 *            user preferred subId.
			...
			public boolean isRingingForSubscriber(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_isRingingForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean isIdleForSubscriber(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_isIdleForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean isRadioOnForSubscriber(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_isRadioOnForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Supply a pin to unlock the SIM for particular subId. Blocks until
			 * a result is determined.
			 * 
			 * @param pin
			 *            The pin to check.
			 * @param subId
			 ...
			 */
			@Override
			public boolean supplyPinForSubscriber(int subId,
					java.lang.String pin) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					_data.writeInt(subId);
					_data.writeString(pin);
					mRemote.transact(Stub.TRANSACTION_supplyPinForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Supply puk to unlock the SIM and set SIM pin to new pin. Blocks
			 * until a result is determined.
			 * 
			 * @param puk
			 *            The puk to check. pin The new pin to be set in SIM
			 * @return whether the operation was a success.
			 */
			@Override
			public boolean supplyPuk(java.lang.String puk, java.lang.String pin)
				...
				try {
					...
					_data.writeString(pin);
					mRemote.transact(Stub.TRANSACTION_supplyPuk, _data, _reply,
							0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public boolean supplyPukForSubscriber(int subId,
					java.lang.String puk, java.lang.String pin)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					_data.writeString(puk);
					_data.writeString(pin);
					mRemote.transact(Stub.TRANSACTION_supplyPukForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Supply a pin to unlock the SIM. Blocks until a result is
			 * determined. Returns a specific success/error code.
			 * 
			 * @param pin
			 *            The pin to check.
			 * @return retValue[0] = Phone.PIN_RESULT_SUCCESS on success.
			 *         Otherwise error code retValue[1] = number of attempts
			 *         remaining if known otherwise -1
			 */
			@Override
			public int[] supplyPinReportResult(java.lang.String pin)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeString(pin);
					mRemote.transact(Stub.TRANSACTION_supplyPinReportResult,
							_data, _reply, 0);
					_reply.readException();
			 ...
			 */
			@Override
			public int[] supplyPinReportResultForSubscriber(int subId,
					java.lang.String pin) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int[] _result;
				try {
					...
					_data.writeString(pin);
					mRemote.transact(
							Stub.TRANSACTION_supplyPinReportResultForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.createIntArray();
				} finally {
			...
			/**
			 * Supply puk to unlock the SIM and set SIM pin to new pin. Blocks
			 * until a result is determined. Returns a specific success/error
			 * code
			 * 
			 * @param puk
			 *            The puk to check pin The pin to check.
			 * @return retValue[0] = Phone.PIN_RESULT_SUCCESS on success.
			 *         Otherwise error code retValue[1] = number of attempts
			 *         remaining if known otherwise -1
			 */
			@Override
			public int[] supplyPukReportResult(java.lang.String puk,
					java.lang.String pin) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int[] _result;
				try {
					...
					_data.writeString(puk);
					_data.writeString(pin);
					mRemote.transact(Stub.TRANSACTION_supplyPukReportResult,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.createIntArray();
				} finally {
			 ...
			 */
			@Override
			public int[] supplyPukReportResultForSubscriber(int subId,
					java.lang.String puk, java.lang.String pin)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				...
				try {
					...
					_data.writeString(pin);
					mRemote.transact(
							Stub.TRANSACTION_supplyPukReportResultForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.createIntArray();
				} finally {
			...
			/**
			 * Handles PIN MMI commands (PIN/PIN2/PUK/PUK2), which are initiated
			 * without SEND (so <code>dial</code> is not appropriate) for a
			 * particular subId.
			 * 
			 * @param dialString
			 *            the MMI command to be executed.
			 ...
			 */
			@Override
			public boolean handlePinMmiForSubscriber(int subId,
				...
				try {
					...
					_data.writeString(dialString);
					mRemote.transact(
							Stub.TRANSACTION_handlePinMmiForSubscriber, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public void toggleRadioOnOffForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_toggleRadioOnOffForSubscriber,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public boolean setRadioForSubscriber(int subId, boolean turnOn)
				...
				try {
					...
					_data.writeInt(subId);
					_data.writeInt(((turnOn) ? (1) : (0)));
					mRemote.transact(Stub.TRANSACTION_setRadioForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean setRadioPower(boolean turnOn)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(((turnOn) ? (1) : (0)));
					mRemote.transact(Stub.TRANSACTION_setRadioPower, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Request to update location information for a subscrition in
			 * service state
			 * 
			 * @param subId
			 *            user preferred subId.
			...
			public void updateServiceLocationForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_updateServiceLocationForSubscriber,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public void enableLocationUpdatesForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_enableLocationUpdatesForSubscriber,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public void disableLocationUpdatesForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_disableLocationUpdatesForSubscriber,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public int getCallStateForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getCallStateForSubscriber, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getActivePhoneType() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getActivePhoneType,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/**
			 * Returns the current active phone type as integer for particular
			 * subId. Returns TelephonyManager.PHONE_TYPE_CDMA if
			 * RILConstants.CDMA_PHONE and TelephonyManager.PHONE_TYPE_GSM if
			...
			public int getActivePhoneTypeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getActivePhoneTypeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getCdmaEriIconIndexForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getCdmaEriIconIndexForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/**
			 * Returns the CDMA ERI icon mode on particular subId, 0 - ON 1 -
			 * FLASHING
			 * 
			 * @param subId
			 *            user preferred subId.
			...
			public int getCdmaEriIconModeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getCdmaEriIconModeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public java.lang.String getCdmaEriTextForSubscriber(int subId)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getCdmaEriTextForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			/**
			 * Returns true if OTA service provisioning needs to run. Only
			 * relevant on some technologies, others will always return false.
			 */
			@Override
			public boolean needsOtaServiceProvisioning()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(
							Stub.TRANSACTION_needsOtaServiceProvisioning,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public boolean setVoiceMailNumber(int subId,
					java.lang.String alphaTag, java.lang.String number)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					_data.writeString(number);
					mRemote.transact(Stub.TRANSACTION_setVoiceMailNumber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 * 
			 * @param subId
			 *            user preferred subId. Returns the unread count of
			 *            voicemails
			 */
			@Override
			public int getVoiceMessageCountForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getVoiceMessageCountForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 * 
			 * @param subId
			 *            user preferred subId. Returns the network type
			 */
			@Override
			public int getNetworkTypeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getNetworkTypeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getDataNetworkType() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getDataNetworkType,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getDataNetworkTypeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getDataNetworkTypeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getVoiceNetworkType() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getVoiceNetworkType,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getVoiceNetworkTypeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getVoiceNetworkTypeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public boolean hasIccCard() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_hasIccCard, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 * 
			 * @param slotId
			 *            user preferred slotId. Return true if an ICC card is
			 *            present
			 */
			@Override
			public boolean hasIccCardUsingSlotId(int slotId)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_hasIccCardUsingSlotId,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Return if the current radio is LTE on CDMA. This is a tri-state
			 * return value as for a period of time the mode may be unknown.
			 *
			 * @return {@link Phone#LTE_ON_CDMA_UNKNOWN},
			 *         {@link Phone#LTE_ON_CDMA_FALSE} or
			 *         {@link PHone#LTE_ON_CDMA_TRUE}
			 */
			@Override
			public int getLteOnCdmaMode() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getLteOnCdmaMode, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getLteOnCdmaModeForSubscriber(int subId)
				...
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getLteOnCdmaModeForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public java.util.List<android.telephony.CellInfo> getAllCellInfo()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getAllCellInfo, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply
							.createTypedArrayList(android.telephony.CellInfo.CREATOR);
				} finally {
					_reply.recycle();
					_data.recycle();
				}
			...
			public void setCellInfoListRate(int rateInMillis)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setCellInfoListRate,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public int getDefaultSim() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getDefaultSim, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@SuppressLint({ "InlinedApi", "NewApi" })
			@Override
			public android.telephony.IccOpenLogicalChannelResponse iccOpenLogicalChannel(
					java.lang.String AID) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_iccOpenLogicalChannel,
							_data, _reply, 0);
					_reply.readException();
					if ((0 != _reply.readInt())) {
						_result = android.telephony.IccOpenLogicalChannelResponse.CREATOR
								.createFromParcel(_reply);
					} else {
						_result = null;
					}
			 ...
			 *
			 * @param channel
			 *            is the channel id to be closed as retruned by a
			...
			public boolean iccCloseLogicalChannel(int channel)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_iccCloseLogicalChannel,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 * @param p3
			 *            P3 value of the APDU command. If p3 is negative a 4
			 *            byte APDU is sent to the SIM.
			 * @param data
			 *            Data to be sent with the APDU.
			 * @return The APDU response from the ICC card with the status
			 *         appended at the end.
			 */
			@Override
			public java.lang.String iccTransmitApduLogicalChannel(int channel,
					int cla, int instruction, int p1, int p2, int p3,
					java.lang.String data) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					mRemote.transact(
							Stub.TRANSACTION_iccTransmitApduLogicalChannel,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			 ...
			 */
			@Override
			public java.lang.String iccTransmitApduBasicChannel(int cla,
					int instruction, int p1, int p2, int p3,
					java.lang.String data) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					_data.writeString(data);
					mRemote.transact(
							Stub.TRANSACTION_iccTransmitApduBasicChannel,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			 ...
			 */
			@Override
			public byte[] iccExchangeSimIO(int fileID, int command, int p1,
					int p2, int p3, java.lang.String filePath)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				byte[] _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_iccExchangeSimIO, _data,
							_reply, 0);
					_reply.readException();
			 ...
			 *            details.
			 * @return The APDU response from the ICC card, with the last 4
			 *         bytes being the status word. If the command fails,
			 *         returns an empty string.
			 */
			@Override
			public java.lang.String sendEnvelopeWithStatus(
					java.lang.String content) throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_sendEnvelopeWithStatus,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			/**
			 * Read one of the NV items defined in {@link RadioNVItems} /
			 * {@code ril_nv_items.h}. Used for device configuration by some
			 * CDMA operators.
			 *
			 * @param itemID
			 ...
			 */
			@Override
			public java.lang.String nvReadItem(int itemID)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_nvReadItem, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			/**
			 * Write one of the NV items defined in {@link RadioNVItems} /
			 * {@code ril_nv_items.h}. Used for device configuration by some
			 * CDMA operators.
			 *
			 * @param itemID
			 ...
			 */
			@Override
			public boolean nvWriteItem(int itemID, java.lang.String itemValue)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_nvWriteItem, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Update the CDMA Preferred Roaming List (PRL) in the radio NV
			 * storage. Used for device configuration by some CDMA operators.
			 *
			 * @param preferredRoamingList
			...
			public boolean nvWriteCdmaPrl(byte[] preferredRoamingList)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_nvWriteCdmaPrl, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Perform the specified type of NV config reset. The radio will be
			 * taken offline and the device must be rebooted after the
			 * operation. Used for device configuration by some CDMA operators.
			 *
			 * @param resetType
			 *            the type of reset to perform (1 == factory reset; 2 ==
			 *            NV-only reset).
			 * @return true on success; false on any failure.
			 */
			@Override
			public boolean nvResetConfig(int resetType)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_nvResetConfig, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/*
			 * Get the calculated preferred network type. Used for device
			 * configuration by some CDMA operators.
			 * 
			 * @return the calculated preferred network type, defined in
			 * RILConstants.java.
			 */
			@Override
			public int getCalculatedPreferredNetworkType()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(
							Stub.TRANSACTION_getCalculatedPreferredNetworkType,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/*
			 * Get the preferred network type. Used for device configuration by
			 * some CDMA operators.
			 * 
			...
			public int getPreferredNetworkType()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getPreferredNetworkType,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/**
			 * Check TETHER_DUN_REQUIRED and TETHER_DUN_APN settings,
			 * net.tethering.noprovisioning SystemProperty, and
			 * config_tether_apndata to decide whether DUN APN is required for
			 * tethering.
			 *
			...
			public int getTetherApnRequired() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getTetherApnRequired,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/**
			 * Set the preferred network type. Used for device configuration by
			 * some CDMA operators.
			 *
			 * @param networkType
			 *            the preferred network type, defined in
			 *            RILConstants.java.
			 * @return true on success; false on any failure.
			 */
			@Override
			public boolean setPreferredNetworkType(int networkType)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setPreferredNetworkType,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public void setDataEnabled(int subId, boolean enable)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setDataEnabled, _data,
							_reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public boolean getDataEnabled(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_getDataEnabled, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Get P-CSCF address from PCO after data connection is established
			 * or modified.
			 * 
			 * @param apnType
			 *            the apnType, "ims" for IMS APN, "emergency" for
			 *            EMERGENCY APN
			 */
			@Override
			public java.lang.String[] getPcscfAddress(java.lang.String apnType)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getPcscfAddress, _data,
							_reply, 0);
					_reply.readException();
			...
			public void setImsRegistrationState(boolean registered)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setImsRegistrationState,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public java.lang.String getCdmaMdn(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_getCdmaMdn, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			public java.lang.String getCdmaMin(int subId)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_getCdmaMin, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			/**
			 * Has the calling application been granted special privileges by
			 * the carrier.
			 *
			 * If any of the packages in the calling UID has carrier privileges,
			 * the call will return true. This access is granted by the owner of
			 * the UICC card and does not depend on the registered carrier.
			 *
			...
			public int getCarrierPrivilegeStatus()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(
							Stub.TRANSACTION_getCarrierPrivilegeStatus, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int checkCarrierPrivilegesForPackage(java.lang.String pkgname)
				...
				try {
					...
					mRemote.transact(
							Stub.TRANSACTION_checkCarrierPrivilegesForPackage,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			/**
			 * Returns the package name of the carrier apps that should handle
			 * the input intent.
			 *
			 * @param packageManager
			 *            PackageManager for getting receivers.
			 * @param intent
			 *            Intent that will be sent.
			 * @return list of carrier app package names that can handle the
			 *         intent. Returns null if there is an error and an empty
			 *         list if there are no matching packages.
			 */
			@Override
			public java.util.List<java.lang.String> getCarrierPackageNamesForIntent(
				...
				try {
					...
					mRemote.transact(
							Stub.TRANSACTION_getCarrierPackageNamesForIntent,
							_data, _reply, 0);
					_reply.readException();
			...
			/**
			 * Set the line 1 phone number string and its alphatag for the
			 * current ICCID for display purpose only, for example, displayed in
			 * Phone Status. It won't change the actual MSISDN/MDN. To unset
			 * alphatag or number, pass in a null value.
			 *
			 * @param subId
			 *            the subscriber that the alphatag and dialing number
			 *            belongs to.
			 * @param alphaTag
			 ...
			 */
			@Override
			public boolean setLine1NumberForDisplayForSubscriber(int subId,
					java.lang.String alphaTag, java.lang.String number)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				...
				try {
					...
					_data.writeString(number);
					mRemote.transact(
							Stub.TRANSACTION_setLine1NumberForDisplayForSubscriber,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			/**
			 * Returns the displayed dialing number string if it was set
			 * previously via {@link #setLine1NumberForDisplay}. Otherwise
			 * returns null.
			 *
			 * @param subId
			 *            whose dialing number for line 1 is returned.
			 * @return the displayed dialing number if set, or null if not set.
			 */
			@Override
			public java.lang.String getLine1NumberForDisplay(int subId)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(subId);
					mRemote.transact(Stub.TRANSACTION_getLine1NumberForDisplay,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			/**
			 * Returns the displayed alphatag of the dialing number if it was
			 * set previously via {@link #setLine1NumberForDisplay}. Otherwise
			 * returns null.
			 *
			 * @param subId
			 *            whose alphatag associated with line 1 is returned.
			 * @return the displayed alphatag of the dialing number if set, or
			 *         null if not set.
			 */
			@Override
			public java.lang.String getLine1AlphaTagForDisplay(int subId)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				java.lang.String _result;
				try {
					...
					_data.writeInt(subId);
					mRemote.transact(
							Stub.TRANSACTION_getLine1AlphaTagForDisplay, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
			...
			public java.lang.String[] getMergedSubscriberIds()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getMergedSubscriberIds,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.createStringArray();
				} finally {
			 ...
			 * provider name (SPN) and the operator name will both be replaced
			 * by the brand value input. To unset the value, the same function
			 * should be called with a null brand value.
			 *
			 * <p>
			 * Requires Permission:
			 * {@link android.Manifest.permission#MODIFY_PHONE_STATE
			 * MODIFY_PHONE_STATE} or has to be carrier app - see
			...
			public boolean setOperatorBrandOverride(java.lang.String brand)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setOperatorBrandOverride,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 *
			 * Using this call, the carrier app (see #hasCarrierPrivileges) can
			 * override the platform's notion of a network operator being
			 * considered roaming or not. The change only affects the ICCID that
			 * was active when this call was made.
			 *
			 * If null is passed as any of the input, the corresponding value is
			 * deleted.
			 *
			 * <p>
			 * Requires that the caller have carrier privilege. See
			 * #hasCarrierPrivileges.
			 *
			 * @param gsmRoamingList
			 *            - List of MCCMNCs to be considered roaming for 3GPP
			 *            RATs.
			 * @param gsmNonRoamingList
			 *            - List of MCCMNCs to be considered not roaming for
			 *            3GPP RATs.
			 * @param cdmaRoamingList
			 *            - List of SIDs to be considered roaming for 3GPP2
			 *            RATs.
			 * @param cdmaNonRoamingList
			 *            - List of SIDs to be considered not roaming for 3GPP2
			 *            RATs.
			 * @return true if the operation was executed correctly.
			 */
			@Override
			public boolean setRoamingOverride(
					java.util.List<java.lang.String> gsmRoamingList,
					java.util.List<java.lang.String> gsmNonRoamingList,
					java.util.List<java.lang.String> cdmaRoamingList,
					java.util.List<java.lang.String> cdmaNonRoamingList)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setRoamingOverride,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 *
			 * @param oemReq
			 *            the data is sent to ril.
			 * @param oemResp
			 *            the respose data from RIL.
			 * @return negative value request was not handled or get error 0
			 *         request was handled succesfully, but no response data
			...
			public int invokeOemRilRequestRaw(byte[] oemReq, byte[] oemResp)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_invokeOemRilRequestRaw,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
			...
			public boolean needMobileRadioShutdown()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_needMobileRadioShutdown,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public void shutdownMobileRadios()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_shutdownMobileRadios,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			 ...
			 *
			 * @param rafs
			 *            an RadioAccessFamily array to indicate all phone's new
			 *            radio access family. The length of RadioAccessFamily
			 *            must equ]]al to phone count.
			 */
			@Override
			public void setRadioCapability(
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setRadioCapability,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public int getRadioAccessFamily(int phoneId)
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getRadioAccessFamily,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 *
			 * @param enable
			 *            Whether to enable video calling.
			 */
			@Override
			public void enableVideoCalling(boolean enable)
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(((enable) ? (1) : (0)));
					mRemote.transact(Stub.TRANSACTION_enableVideoCalling,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			 ...
			 *
			 * @return {@code True} if the user has enabled video calling,
			...
			public boolean isVideoCallingEnabled()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_isVideoCallingEnabled,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean isImsRegistered() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_isImsRegistered, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 * GSM and the MEID for CDMA phones. Return null if device ID is not
			 * available.
			 *
			 * <p>
			 * Requires Permission:
			...
			public java.lang.String getDeviceId()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getDeviceId, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readString();
				} finally {
	...
	/**
	 * Supply a pin to unlock the SIM for particular subId. Blocks until a
	 ...
	 * @return whether the operation was a success.
	 */
	public boolean supplyPinForSubscriber(int subId, java.lang.String pin)
			throws android.os.RemoteException;

	/**
	 * Supply puk to unlock the SIM and set SIM pin to new pin. Blocks until a
	 * result is determined.
	 * 
	 * @param puk
	 *            The puk to check. pin The new pin to be set in SIM
	 ...
	 * @return whether the operation was a success.
	 */
	public boolean supplyPukForSubscriber(int subId, java.lang.String puk,
			java.lang.String pin) throws android.os.RemoteException;
	 ...
	 * @param pin
	 *            The pin to check.
	 * @return retValue[0] = Phone.PIN_RESULT_SUCCESS on success. Otherwise
	 *         error code retValue[1] = number of attempts remaining if known
	 *         otherwise -1
	 */
	public int[] supplyPinReportResult(java.lang.String pin)
			throws android.os.RemoteException;
	...
	/**
	 * Supply puk to unlock the SIM and set SIM pin to new pin. Blocks until a
	 * result is determined. Returns a specific success/error code
	 * 
	 * @param puk
	 *            The puk to check pin The pin to check.
	 * @return retValue[0] = Phone.PIN_RESULT_SUCCESS on success. Otherwise
	...
	/**
	 * Handles PIN MMI commands (PIN/PIN2/PUK/PUK2), which are initiated without
	 * SEND (so <code>dial</code> is not appropriate) for a particular subId.
	 * 
	 * @param dialString
	 *            the MMI command to be executed.
	 * @param subId
	 ...
	 */
	public boolean handlePinMmiForSubscriber(int subId,
			java.lang.String dialString) throws android.os.RemoteException;
	 ...
	 */
	public java.util.List<android.telephony.NeighboringCellInfo> getNeighboringCellInfo(
			java.lang.String callingPkg) throws android.os.RemoteException;
	 ...
	 * Returns TelephonyManager.PHONE_TYPE_CDMA if RILConstants.CDMA_PHONE and
	 * TelephonyManager.PHONE_TYPE_GSM if RILConstants.GSM_PHONE
	 * 
	 * @param subId
	 *            user preferred subId.
	...
	/**
	 * Returns true if OTA service provisioning needs to run. Only relevant on
	 * some technologies, others will always return false.
	 */
	public boolean needsOtaServiceProvisioning()
			throws android.os.RemoteException;
	 ...
	 * Sets the voicemail number for a particular subscriber.
	 */
	public boolean setVoiceMailNumber(int subId, java.lang.String alphaTag,
			java.lang.String number) throws android.os.RemoteException;
	 ...
	 * 
	 * @param subId
	 *            user preferred subId. Returns the unread count of voicemails
	 */
	public int getVoiceMessageCountForSubscriber(int subId)
			throws android.os.RemoteException;
	 ...
	 * 
	 * @param slotId
	 *            user preferred slotId. Return true if an ICC card is present
	 */
	public boolean hasIccCardUsingSlotId(int slotId)
			throws android.os.RemoteException;
	 ...
	 *         the end.
	 */
	public java.lang.String iccTransmitApduLogicalChannel(int channel, int cla,
			int instruction, int p1, int p2, int p3, java.lang.String data)
			throws android.os.RemoteException;
	 ...
	 * @return The APDU response.
	 */
	public byte[] iccExchangeSimIO(int fileID, int command, int p1, int p2,
			int p3, java.lang.String filePath)
			throws android.os.RemoteException;
	 ...
	 *
	 * @param contents
	 *            String containing SAT/USAT response in hexadecimal format
	 *            starting with command tag. See TS 102 223 for details.
	 * @return The APDU response from the ICC card, with the last 4 bytes being
	 *         the status word. If the command fails, returns an empty string.
	 */
	public java.lang.String sendEnvelopeWithStatus(java.lang.String content)
			throws android.os.RemoteException;

	/**
	 * Read one of the NV items defined in {@link RadioNVItems} /
	 * {@code ril_nv_items.h}. Used for device configuration by some CDMA
	 * operators.
	 *
	 * @param itemID
	 *            the ID of the item to read.
	...
	/**
	 * Perform the specified type of NV config reset. The radio will be taken
	 * offline and the device must be rebooted after the operation. Used for
	 * device configuration by some CDMA operators.
	 *
	 * @param resetType
	 *            the type of reset to perform (1 == factory reset; 2 == NV-only
	 *            reset).
	 * @return true on success; false on any failure.
	 */
	public boolean nvResetConfig(int resetType)
	...
	/*
	 * Get the calculated preferred network type. Used for device configuration
	 * by some CDMA operators.
	 * 
	 * @return the calculated preferred network type, defined in
	 * RILConstants.java.
	 */
	...
	/**
	 * Check TETHER_DUN_REQUIRED and TETHER_DUN_APN settings,
	 * net.tethering.noprovisioning SystemProperty, and config_tether_apndata to
	 * decide whether DUN APN is required for tethering.
	 *
	 * @return 0: Not required. 1: required. 2: Not set.
	 */
	public int getTetherApnRequired() throws android.os.RemoteException;
	...
	/**
	 * Set the preferred network type. Used for device configuration by some
	 * CDMA operators.
	 *
	 * @param networkType
	...
	/**
	 * Get P-CSCF address from PCO after data connection is established or
	 * modified.
	 * 
	 * @param apnType
	 *            the apnType, "ims" for IMS APN, "emergency" for EMERGENCY APN
	 */
	public java.lang.String[] getPcscfAddress(java.lang.String apnType)
			throws android.os.RemoteException;
	...
	/**
	 * Has the calling application been granted special privileges by the
	 * carrier.
	 *
	...
	/**
	 * Returns the package name of the carrier apps that should handle the input
	 * intent.
	 *
	 * @param packageManager
	 *            PackageManager for getting receivers.
	 ...
	 *         Returns null if there is an error and an empty list if there are
	 ...
	 * for display purpose only, for example, displayed in Phone Status. It
	 * won't change the actual MSISDN/MDN. To unset alphatag or number, pass in
	 * a null value.
	 *
	 * @param subId
	 *            the subscriber that the alphatag and dialing number belongs
	 *            to.
	 * @param alphaTag
	 *            alpha-tagging of the dailing nubmer
	 * @param number
	 ...
	 * Override the operator branding for the current ICCID.
	 *
	 * Once set, whenever the SIM is present in the device, the service provider
	 * name (SPN) and the operator name will both be replaced by the brand value
	 * input. To unset the value, the same function should be called with a null
	 * brand value.
	 *
	 * <p>
	 * Requires Permission:
	 ...
	 * the platform's notion of a network operator being considered roaming or
	 * not. The change only affects the ICCID that was active when this call was
	 * made.
	 *
	 * If null is passed as any of the input, the corresponding value is
	 * deleted.
	 ...
	 *
	 * @param gsmRoamingList
	 *            - List of MCCMNCs to be considered roaming for 3GPP RATs.
	 * @param gsmNonRoamingList
	 *            - List of MCCMNCs to be considered not roaming for 3GPP RATs.
	 * @param cdmaRoamingList
	 *            - List of SIDs to be considered roaming for 3GPP2 RATs.
	 * @param cdmaNonRoamingList
	 *            - List of SIDs to be considered not roaming for 3GPP2 RATs.
	 * @return true if the operation was executed correctly.
	 */
	public boolean setRoamingOverride(
			java.util.List<java.lang.String> gsmRoamingList,
	 ...
	 * @param oemResp
	 *            the respose data from RIL.
	 * @return negative value request was not handled or get error 0 request was
	 *         handled succesfully, but no response data positive value success,
	 ...
	 *
	 * @param rafs
	 *            an RadioAccessFamily array to indicate all phone's new radio
	 *            access family. The length of RadioAccessFamily must equ]]al to
	 *            phone count.
	 */
	public void setRadioCapability(android.telephony.RadioAccessFamily[] rafs)
			throws android.os.RemoteException;
	 ...
	 * Whether video calling has been enabled by the user.
	 *
	 * @return {@code True} if the user has enabled video calling, {@code false}
	 *         otherwise.
	 */
	...
	/**
	 * Returns the unique device ID of phone, for example, the IMEI for GSM and
